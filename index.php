 ...
 * 本项目是依据 [baiduwp-php](https://github.com/yuantuo666/baiduwp-php "baiduwp-php") 优化而来，仅供大家学习参考。
 *
 * 希望在使用时能够保留导航栏的 Made by Yuan_Tuo 和 Optimized by LC，感谢！
 *
 * 请勿随意修改此文件！如需更改相关配置请到 config.php ！
 *
 * 此项目 GitHub 地址：https://github.com/lc6464/PanDownload-PHP-Optimized
 *
 * @version 1.3.5
 *
...
if (!(file_exists('config.php') && file_exists('functions.php'))) {
	http_response_code(503); header('Content-Type: text/plain; charset=utf-8'); header('Refresh: 5;url=https://github.com/lc6464/PanDownload-PHP-Optimized');
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="collpase-bar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="https://github.com/lc6464/PanDownload-PHP-Optimized" target="_blank">GitHub 仓库</a></li>
					<li class="nav-item"><a class="nav-link" href="https://github.com/lc6464/PanDownload-PHP-Optimized/releases/tag/<?php echo programVersion; ?>" target="_blank">版本：<?php echo programVersion; ?></a></li>
